...
#dlib module can recognize humans and other objects
#adaptive threshold
            ...
            for x,b in enumerate(boxes.splitlines()):
                if x != 0:
                    ...
                    if len(b) == 12:
                        ...
                        #cv2.putText(gray,original_text,(x,y),cv2.FONT_HERSHEY_COMPLEX,1,(50,50,255),2)
                        try:
                            #finds which language the original text is in
                            language = single_detection(original_text, api_key="4a6d0a2c4b1703aaf37066f1807dccda")
